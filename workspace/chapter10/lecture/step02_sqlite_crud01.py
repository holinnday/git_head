...
try :
    conn = sqlite3.connect("D:/git_office/workspace/chapter10/data/sqlite1_db")  # db가 새로 생성되고 object(conn)로 연결됨
    ...
    cursor.execute("insert into goods(code, name) values(3, '전자레인지')") #일부 칼럼만 넣을 경우 칼럼 이름을 정의해줘야함
